...
public class TPRecherche extends javax.swing.JPanel {
	...
	public TPRecherche(String sid_user) {
		super();
		id_user = sid_user;
		initGUI();
	}
					...
					jPanel3.setPreferredSize(new java.awt.Dimension(719, 32));
					{
						...
						jButton1.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent evt) {
								...
								String[][] mobj = abdd.recherche_multi(id_user, jTextField1.getText(), jTextField2.getText(), jTextField3.getText() );
